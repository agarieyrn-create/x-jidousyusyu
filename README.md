...
| 8 | 「自分向けに変換」= 最低3案のアイデア生成 (経験を入れる場所を必ず提示) | ✅ |
...
| 15 | Unit テスト (X Query / X URL / Trend Score / AI Mock / Export) | ✅ |
...
- 認証は最小限 (1ユーザー = デモワークスペース単位)。複数ユーザー対応は Phase 3 で追加予定
